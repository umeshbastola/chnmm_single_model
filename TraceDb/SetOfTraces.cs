...
namespace TraceDb
{
    public class SetOfGestureTraces : IEnumerable<KeyValuePair<string, GestureTraces>>
    {
        ...
        //public IEnumerable<ClassificationResult> testRecognitionSystem(CHnMMClassificationSystem system, int subsetIndex)
        //{
        ...
        //            yield return new ClassificationResult(gesture.Key, recogGesture, (int)recogTime, trace.ID, failReason);
        //        }
        //    }
        //}
